...
2. Clone your fork: `git clone https://github.com/your-username/bedrock-autoloader-mu.git`
...
### Installation
```bash
git clone https://github.com/wp-spaghetti/bedrock-autoloader-mu.git
cd bedrock-autoloader-mu
composer install
```
